                ...
                <div class="md:w-1/3 w-full px-4">
                    <div class="">
                        <div class="flex flex-col">
                            <div class="relative">
                                <img class="hidden object-contain w-full lg:block" src="{{ asset('images/Rectangle-23.png') }}" alt="bag" />
                                <img class="hidden object-contain w-full sm:block lg:hidden" src="{{ asset('images/Rectangle-24.png') }}"
                                    alt="bag" />
                                <img class="w-full  object-contain sm:hidden" src="{{ asset('images/Rectangle-5.png') }}" alt="bag" />
