        ...
        <div class="mx-auto container px-4 md:px-6 2xl:px-0 py-12 flex justify-center items-center">
            <div class="flex flex-col jusitfy-start items-start">
              ...
              <div class="mt-10 lg:mt-12 grid grid-cols-1 lg:grid-cols-3 gap-x-8 gap-y-10 lg:gap-y-0">
                ...
                <div class="flex flex-col">
                  <div class="relative">
                    <img class="hidden lg:block" src="{{asset('images/Rectangle-5.png')}}" alt="shoes" />
                    <img class="hidden sm:block lg:hidden"  src="{{asset('images/Rectangle-5.png')}}" alt="shoes" />
                    <img class="sm:hidden"  src="{{asset('images/Rectangle-5.png')}}" alt="shoes" />
