<footer class="footer">
    <div class="bg-gray-800 py-44">
        <div class="mx-auto container px-4">
            <div class="flex flex-wrap -mx-4 md:space-y-0 space-y-12">
                <div class="md:w-1/4 w-full px-4">
                    <div class="">
                        <div class="flex items-center  space-x-2">
                            <a href="#" class="text-xl font-bold text-white ">Dynamic Blog </a>
                        </div>
                        <p class="text-sm leading-6  mt-4 text-gray-400"> Centered with bottom border · Simple links
                            centered · Simple links on left · With full-width flyouts · Simple branded with stacked
                            links · We've got more ...</p>
                        <div class="flex items-center space-x-4 mt-12">
                            <button aria-label="instagram"
                                class=" group focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-800 w-10 h-10 flex-shrink-0 bg-white cursor-pointer hover:bg-green-600  rounded-full flex items-center justify-center">
                                <svg width="18" height="17" viewBox="0 0 18 17" fill="none"
                                    ...
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                        ...
                                        fill="currentColor" class="text-gray-600 group-hover:text-white" />
                                </svg>
                            </button>
                ...
                <div class="md:w-1/4 w-full px-4">
                    <div class="sm:ml-0 flex flex-col">
                        <h2 class="text-xl font-bold leading-4 text-white dark:text-white">Company</h2>
                        <a href="javascript:void(0)"
                            class="focus:outline-none focus:underline hover:text-green-600 text-base leading-4 mt-8 text-gray-400 cursor-pointer">Blog</a>
                        <a href="javascript:void(0)"
                            class="focus:outline-none focus:underline hover:text-green-600 text-base leading-4 mt-8 text-gray-400 cursor-pointer">Pricing</a>
                        <a href="javascript:void(0)"
                            class="focus:outline-none focus:underline hover:text-green-600 text-base leading-4 mt-8 text-gray-400 cursor-pointer">About
                            Us</a>
                        <a href="javascript:void(0)"
                            class="focus:outline-none focus:underline hover:text-green-600 text-base leading-4 mt-8 text-gray-400 cursor-pointer">Contact
                            us</a>
                        <a href="javascript:void(0)"
                            class="focus:outline-none focus:underline hover:text-green-600 text-base leading-4 mt-8 text-gray-400 cursor-pointer">Testimonials</a>
                    </div>
                </div>
                <div class="md:w-1/4 w-full px-4">
                    <div class="flex flex-col">
                        <h2 class="text-xl font-bold leading-5 text-white">Support</h2>
                        <a href="javascript:void(0)"
                            class="focus:outline-none focus:underline hover:text-green-600 text-base leading-4 mt-8 text-gray-400 cursor-pointer">Legal
                            policy</a>
                        <a href="javascript:void(0)"
                            class="focus:outline-none focus:underline hover:text-green-600 text-base leading-4 mt-8 text-gray-400 cursor-pointer">Status
                            policy</a>
                        <a href="javascript:void(0)"
                            class="focus:outline-none focus:underline hover:text-green-600 text-base leading-4 mt-8 text-gray-400 cursor-pointer">Privacy
                            policy</a>
                        <a href="javascript:void(0)"
                            class="focus:outline-none focus:underline hover:text-green-600 text-base leading-4 mt-8 text-gray-400 cursor-pointer">Terms
                            of service</a>
                    </div>
                </div>
                <div class="md:w-1/4 w-full px-4">
                    <div class="">
                        <form action="" method="get">
                            <label class="text-xl font-bold leading-5 text-white">Get
                                updates</label>
                            <div class="card-mail md:flex items-center mt-8 md:space-y-0 space-y-4">
                                <input type="email"
                                    class="border-l border-t border-b border-gray-200  w-full text-base md:text-lg px-3 py-3 focus:outline-none"
                                    placeholder="Enter Your Email">
                                <input type="submit" value="Send"
                                    class="cursor-pointer bg-green-600 md:w-1/3 w-full hover:bg-green-400 text-white font-bold capitalize px-3 py-3 text-base md:text-lg  border-t border-r border-b border-green-600">
                            </div>
                        </form>
                    </div>
                </div>
